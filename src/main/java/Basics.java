...
public class Basics {
    ...
    public static String split(String to_split) {
        ...
        ret.append(sta[0].charAt(0));
        ret.append(sta[1].charAt(0));
        ret.append(sta[2].charAt(0));
        ret.append(sta[3].charAt(0));
        ret.append(sta[4].charAt(0));
        ret.append(sta[5].charAt(0));
        ret.append(sta[6].charAt(0));
        return ret.toString();
